...
namespace CakeRobot.Controllers.Kinect
{
    ...
    public partial class MainWindow : Window
    {
        ...
        /// </summary>
        private readonly Pen _trackedBonePen = new Pen(Brushes.Aqua, 6);
        ...
        private ConnectionHelper _helper = new ConnectionHelper();
        ...
        private void WindowLoaded(object sender, RoutedEventArgs e)
        {
            ...
            Image.Source = this._imageSource;
            ...
            try
            {
                this.statusBarText.Text = "Wait, Connecting via BlueTooth..";
                _helper.Initialize();
                this.statusBarText.Text = "Done Connecting via BlueTooth";
            }
            catch(Exception ex)
            {
                this.statusBarText.Text = "Can't Connect via bluetooth";
            }
            ...
            using (DrawingContext dc = this._drawingGroup.Open())
            {
                ...
                if (skeletons.Length != 0)
                {
                    foreach (Skeleton skeleton in skeletons)
                    {
                        ...
                        {
                            _helper.ProcessCommand(skeleton);
